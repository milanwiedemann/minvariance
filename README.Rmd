...
<!-- badges: start -->
<!-- badges: end -->
The goal of `minvariance` is to aid the understanding of longitudinal measurement invariance and see which parts of this method can be automated. 
The vignettes on the [website of this package](https://milanwiedemann.github.io/minvariance/) replicate some examples found online. 
